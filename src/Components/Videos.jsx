    ...
    return (
        <Stack direction={["column","row"]} h = "100vh">
            ...
            <VStack w="full">
                ...
                <Heading alignItems={"flex-end"} w="full" paddingLeft={"5"}>Lecture 1</Heading>
                <Text alignItems={"flex-start"} overflow={"auto"} w="full" paddingLeft={"5"}> In this lecture we will learn
                the basic of data structure and algorithm.</Text>
            </VStack>
